...
import { adminRole, AdminTableColumns, AdminTableRows, COLORS } from "@src/constant";
...
const AdminManagementScreen = () => {
    ...
    const [modalType, setModalType] = useState<ModalType>("add"); // <-- open Add modal by default
    ...
    return (
        <AppLayout>
            <FormProvider {...methods}>
                <CustomPageHeader subtitle="Manage administrator access and permissions" title="Admin Accounts">
                    <CustomButton
                        title="Add Admin"
                        startIcon={<Add />}
                        variant="contained"
                ...
                <DynamicTable
                    ...
                    rowMenu={(row) => [
                        {
                            title: "Edit",
                            icon: <img src="/assets/icons/editIcon.svg" alt="" style={{ width: 16, height: 16 }} />,
                            onClick: () => openModal("edit", row),
                        },
                        {
                            title: "Resend Invite",
                            icon: <img src="/assets/icons/MessageIcon.svg" alt="" style={{ width: 16, height: 16 }} />,
                            onClick: () => console.log("Resend clicked", row),
                        },
                        {
                            title: "Reactivate",
                            icon: <img src="/assets/icons/shieldIcon.svg" alt="" style={{ width: 16, height: 16 }} />,
                        ...
                        {
                            title: "Delete",
                            icon: <img src="/assets/icons/trashIcon.svg" alt="" style={{ width: 16, height: 16 }} />,
                    ...
                    >
                        <form onSubmit={methods.handleSubmit(handleSubmit)}>
                            <Stack gap="16px">
                                ...
                                >
                                    <Typography variant="bodySmall" color={COLORS.text.primary} mb={1}>
                                        Role Permissions:
                                    </Typography>
