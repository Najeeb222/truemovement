...
const AnnouncementsScreen = () => {
    const [enabledStates, setEnabledStates] = useState<boolean[]>([true, false, true])
    ...
    const announcementsData = [
        ...
        },
        {
            ...
            description: "Target users who started but did not complete a specific Session/Program",
        },
        {
            icon: <GrowthIcon />,
            title: "Streak Encouragement",
            status: "active" as const,
            description: "Nudge when a streak is at risk, or celebrate streak milestones",
        },
    ]
    ...
    return (
        ...
        <Stack gap={'24px'}>
                 <CustomPageHeader
                title="Event-Triggered Notifications" subtitle="Configure app-store compliant push and in-app notifications triggered by user actions" />
