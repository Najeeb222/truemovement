import { ContentLibraryCustomHeader, CustomButton, CustomUpload } from "@src/shared/components"
    ...
    return (
        <AppLayout>
            <FormProvider {...methods}>
                ...
                <ContentLibraryCustomHeader backTitle="Sessions" title="Upload New Session" subtitle="Add a new video session to the content library" />

                <CustomBasicInformation />
                <CustomUpload name="sessionThumbnail" type="image" label="Thumbnail Image" />
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <CustomButton title="Cancel" variant="outlined" active background="transparent" />
                    <Stack direction={'row'} sx={{ gap: '16px' }}>
                        <CustomButton title={"Save as Draft"} variant="outlined" background={COLORS.primary.main} active />
