  ...
  return (
    ...
    >
      ...
      >
        <Box
          component="img"
          src="/assets/images/dashbaordLogo.svg"
          sx={{ width: 170 }}
        />
      </Box>
      ...
      >
        {pages.map((page: any) => {
          ...
          const isSubMenuActive =
            page.submenu &&
            page.submenu.some((item: any) =>
              location.pathname.startsWith(item.path),
            );
          const isCreateRouteActive =
            page.title === "Content Library" &&
            location.pathname.includes("create-");
          const shouldShowAsActive =
            isActive || isSubMenuActive || isCreateRouteActive;
            ...
            <Box key={page.title}>
              <ListItem
                ...
                sx={{
                  ...
                  textDecoration: "none",
                  cursor: "pointer",
                  backgroundColor: shouldShowAsActive
